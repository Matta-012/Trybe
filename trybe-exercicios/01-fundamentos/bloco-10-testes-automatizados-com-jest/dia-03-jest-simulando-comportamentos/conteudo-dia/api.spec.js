...
describe("testando a requisição", () => {
  // const apiURL = jest.spyOn( api, "fetchURL"); //Faz as requisições à API
  const apiURL = jest.fn().mockResolvedValue(requestReturn); // Simula a requisição, não chega a realizá-la.
